				...
				try{
					Material material = null;
						...
						for (String materialTemp : arrayOfMaterial) {
							material = new Material();
							if(materialTemp.contains(ApplicationConstants.CONST_DELIMITER_FSLASH)){
								Combo combo=new Combo();
								String mtrltemp[]=materialTemp.split(ApplicationConstants.CONST_DELIMITER_FSLASH);
								material.setName(mtrltemp[0]);
								material.setAlias(materialTemp);
								combo.setName(mtrltemp[1]);
								material.setCombo(combo);
