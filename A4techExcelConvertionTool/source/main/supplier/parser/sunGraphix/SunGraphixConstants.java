...
public class SunGraphixConstants {
	...
	static {
		...
		SUNCOLOR_MAP.put("ROSE GOLD","GOLD METAL");
		SUNCOLOR_MAP.put("GOLD","GOLD METAL");
		SUNCOLOR_MAP.put("ORCHID","BRIGHT PURPLE");
		SUNCOLOR_MAP.put("DUCK EGG BLUE","MEDIUM BLUE");
		SUNCOLOR_MAP.put("ROSE","MEDIUM RED");
		SUNCOLOR_MAP.put("VISTA BLUE","MEDIUM BLUE");
		SUNCOLOR_MAP.put("POPPY","MEDIUM RED");
		SUNCOLOR_MAP.put("NAVY","DARK BLUE");
		SUNCOLOR_MAP.put("LIGHT CREAM","LIGHT YELLOW");
		SUNCOLOR_MAP.put("SILVER","SILVER METAL");
		SUNCOLOR_MAP.put("STONE","MEDIUM GRAY");
		SUNCOLOR_MAP.put("RASPBERRY","DARK RED");
