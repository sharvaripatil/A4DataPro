...
public class SunGraphixRevisedMapping implements ISupplierParser{
		...
		Set<String>  productXids = new HashSet<String>();
		  ...
		  try{
				...
				case 36: //Dividers
					...
					break;
				case 37: //Filofax Insert Pages 2pgs    // Filofax Insert Pages
					//create option over here
					try{
					...
					break;
				case 38: //Filofax Insert Pages 4 pgs
					//create option over here
					try{
					String filofaxChrg=CommonUtility.getCellValueStrinOrInt(cell);
					 if(!StringUtils.isEmpty(filofaxChrg) && !filofaxChrg.equals("n/a")){
					...
					break;
				case 39: //Filofax Insert Pages 6 pgs
					//create option over here
					try{
					String filofaxChrg=CommonUtility.getCellValueStrinOrInt(cell);
					 if(!StringUtils.isEmpty(filofaxChrg) && !filofaxChrg.equals("n/a")){
					...
					break;
				case 40: //Filofax Insert Pages 8 pgs
					//create option over here
					try{
					String filofaxChrg=CommonUtility.getCellValueStrinOrInt(cell);
					 if(!StringUtils.isEmpty(filofaxChrg) && !filofaxChrg.equals("n/a")){
				...
				case 44: //Drop Shipments
					...
					break;
				case 45: //Distributor Comments Only
				...
				case 54: //Mailer
					...
					//packaging over here
				case 55://Optional upgrade packaging
					String packageValue=CommonUtility.getCellValueStrinOrInt(cell);
					 if(!StringUtils.isEmpty(packageValue)){
						 List<Packaging>          listPackagingM               = new ArrayList<Packaging>();
						 listPackagingM=sunGraphixAttributeParser.getPackaging(packageValue,productConfigObj.getPackaging());
						 productConfigObj.setPackaging(listPackagingM);
					 }
				...
				case 59: //keyword
					...
					//need to work on dis
					break;
				case 60: //main product
					String largeImage = CommonUtility.getCellValueStrinOrInt(cell);
					if(!StringUtils.isEmpty(largeImage) && !largeImage.equals("n/a")){
						imagesList.add(largeImage);
					}
					//need to work on dis
					break;
				case 61: //Blank Image 1
					//need to work on dis
					// Product images
					String highImage = CommonUtility.getCellValueStrinOrInt(cell);
					if(!StringUtils.isEmpty(highImage) && !highImage.equals("n/a") ){
	...
	private boolean isLineNameOrTradeName(String value) {
		if (value.equalsIgnoreCase("Filofax")) {
			return true;
		} else if (value.equalsIgnoreCase("Letts")) {
			return true;
		} 
			return false;
	}
	public boolean isRepeateColumn(int columnIndex){
	 ...
	 /*if(columnIndex != 4&&columnIndex != 5&&columnIndex != 6 && columnIndex != 7 && columnIndex != 8 && columnIndex != 9 &&
				...
				columnIndex != 62 )
	    {*/
		 if(columnIndex != 1 && columnIndex != 2 && columnIndex != 3 && columnIndex != 14 && columnIndex != 60 && columnIndex != 61)
		    {
