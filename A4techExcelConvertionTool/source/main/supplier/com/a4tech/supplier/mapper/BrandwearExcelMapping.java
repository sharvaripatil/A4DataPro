...
public class BrandwearExcelMapping implements IExcelParser {
	...
	private static final Logger _LOGGER = Logger.getLogger(BrandwearExcelMapping.class);
	...
	public String readExcel(String accessToken, Workbook workbook,
				...
				while (cellIterator.hasNext()) {
					...
					case 39://Logoing Techniques
                    	...
                    	if(!StringUtils.isEmpty(imprintMethod)){
                    	 ImprintMethodList=productAttributeObj.getImprintMethod(imprintMethod);
                    ...
                    case 44://Fabric
                    	...
                    	if(!StringUtils.isEmpty(MaterialAlias)){
                    		MaterialAliceName=MaterialAliceName.concat(MaterialAlias).concat("--");
                    	}else
                    	{
                    		MaterialAlias="";
                    	}
                    ...
                    case 45://Fabric Content
                    	...
                    	MaterialValues=MaterialAliceName.concat(MaterialValues);
                    	MaterialList=productAttributeObj.getMaterial(MaterialValues);
                    ...
                    case 54://Shipping Weight
                    	...
                    	if(!StringUtils.isEmpty(shippingWeight)){
                     		shippingObj=productAttributeObj.getshippingWeight(shippingWeight);
                    		productConfigObj.setShippingEstimates(shippingObj);
                    	}
                    	break;
                    case 55://Made in the USA
                    	...
                    	break;
                    case 56://F.O.B Point
                    	String FOBPint=CommonUtility.getCellValueStrinOrInt(cell);
		...
		public void setProductAttributeObj(BrandwearProductAttribure productAttributeObj) {
